...
Here, we will first split the raw data which was collected for 24 hours at a site, for 7 days at a stretch. Deployment schedule was set to record for 4-minutes and switched off for 1-min. For the sake of analysis, data was split into 10s chunks and annotated manually using Raven Pro. 
```{r}
...
time_str <- time_str[time_str>="160000" & time_str <="190000"]
