...
We now run generalized linear mixed models (GLMM) assuming gaussian errors to examine the effects of restoration type (benchmark, actively restored and passively restored) on bird species proportions (for rainforest and open-country species), followed by TukeyHSD multiple comparisons tests of means. 
