...
all_veg <- left_join (all_veg, veg) 

%>% 
  rename (Density = "count", Richness = "richness", Height = "height", BasalArea = "basal_area", VerticalStratification = "Foliage_score", CanopyCover = "Canopy_cover")
```
