...
# Exploratory analysis using the monitoR and seewave package

In this script, I estimate spectrogrpahic cross correlation and calculate correlation scores.
...
```{r}
list.wav.file.names <- list.files("-insert-file-path-here", full.names = T)
