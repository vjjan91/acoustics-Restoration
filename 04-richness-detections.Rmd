...
a) Site-wise species richness to understand if species composition across sites are distinctly different. 
b) Number of detections across sites
c) Repeat the above as a function of species trait - If a species is a rainforest specialist or an open-country generalist.
...
# Save the nDetections_Site file for the next script

# Amrutha - can you annotate the next script and work the rest based on the above edits? 
