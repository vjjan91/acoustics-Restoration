...
In this script, we will calculate the proportion of rainforest and open-country bird species that was detected across the three treatment types.  
...
ggsave(fig_propRF, filename = "figs/fig_acousticDetections_propRF.png", width=12, height=7,
