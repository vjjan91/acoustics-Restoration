...
Previously, we calculated species richness and number of detections for every 16-min duration across sites and treatment types. Here, we prepare the vegetation data to run GLMs in the next series of scripts. 
