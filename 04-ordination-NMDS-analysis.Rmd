...
data <- read.csv("D:\\VR-Project\\Annotation\\Ordination(NMDS) Analysis\\2020-summer-annotation-working document.csv")
data
```
...
legend("bottomright", c("overall", "Benchmark", "Passive", "Active"), pch = c(1,1,1), col= c("black","green","red", "blue"))
